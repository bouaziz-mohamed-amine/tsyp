		...
		<div>
			...
			{firstProgramData.map((item, index) => (
				<div key={index} className="my-8">
					<div className="mx-8">
						<span className=" me-2 ms-3 relative left-[-100px] top-[-20px] ml-4 flex w-1/6 flex-nowrap rounded bg-blue-100 px-2.5 py-0.5 text-sm font-medium text-blue-800 dark:bg-blue-900 dark:text-blue-300">
							{item.time1}
						</span>
					</div>
					<ol class="items-center sm:flex">
						{item.activities.map((item1, index1) => (
							<li key={index1} class="relative mx-4 mb-6 sm:mb-0">
								<div class="flex items-center">
									<div class="z-10 flex h-6 w-6 shrink-0 items-center justify-center rounded-full bg-blue-100 ring-0 ring-white dark:bg-blue-900 dark:ring-gray-900 sm:ring-8">
										<svg
			...
			{show &&
				secondProgramData.map((item2, index2) => (
					<div key={index2} className="my-8" >
						<div className="mx-8" >
							<span className=" me-2 ms-3 relative left-[-100px] top-[-20px] ml-4 flex w-1/6 flex-nowrap rounded bg-blue-100 px-2.5 py-0.5 text-sm font-medium text-blue-800 dark:bg-blue-900 dark:text-blue-300">
								{item2.time1}
							</span>
						...
						<ol class="items-center sm:flex">
							{item2.activities.map((item3, index3) => (
								<li key={index3} class="relative mx-4 mb-6 sm:mb-0">
									<div class="flex items-center">
										<div class="z-10 flex h-6 w-6 shrink-0 items-center justify-center rounded-full bg-blue-100 ring-0 ring-white dark:bg-blue-900 dark:ring-gray-900 sm:ring-8">
											<svg
												class="h-2.5 w-2.5 text-blue-800 dark:text-blue-300"
			...
			<button
				type="button"
				onClick={ShowMore}
				className="me-2 relative left-36 mb-8 mt-2 mb-2 items-center rounded-lg border border-gray-200 bg-white py-2.5 px-5 text-sm font-medium text-gray-900 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:outline-none focus:ring-4 focus:ring-gray-100 dark:border-gray-600 dark:bg-gray-800 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white dark:focus:ring-gray-700"
			>

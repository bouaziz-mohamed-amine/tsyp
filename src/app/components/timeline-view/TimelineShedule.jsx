			...
			<div>
				<ol class="border-s border-gray relative mb-8 dark:border-gray-700">
					...
					{/* <li class="realtive">
						<span
							style={{ left: "-11px" }}
							class=" absolute flex h-6 w-6 items-center justify-center rounded-full bg-blue-100 ring-8 ring-white dark:bg-blue-900 dark:ring-gray-900"
						>
							<svg
								class="h-2.5 w-2.5 text-blue-800 dark:text-blue-300"
								aria-hidden="true"
						...
						<div className="border-2  border-r-0 border-t-0 border-b-0 p-8">
							<h1 class="mb-1 flex items-center text-2xl font-bold text-gray-900 dark:text-white">
								Check-in
								<span class="me-2 ms-3 ml-4 rounded bg-blue-100 px-2.5 py-0.5 text-sm font-medium text-blue-800 dark:bg-blue-900 dark:text-blue-300">
									Latest
								</span>

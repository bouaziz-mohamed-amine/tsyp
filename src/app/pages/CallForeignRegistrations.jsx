...
export default function ForeignRegistrationPage() {
	return (
		<div className="h-full">
			<h1 className="mb-4 text-4xl font-bold lg:mt-8 text-center lg:text-5xl lg:font-extrabold lg:leading-none">
				IEEE Tunisian SYP Congress 2024
			</h1>
			<h3 className="mb-4 text-2xl font-bold lg:mb-8 text-center lg:text-2xl lg:font-extrabold lg:leading-none">
				Registration for the IEEE Tunisian SYP Congress 2024 is NOW OPEN for
				FOREIGN IEEE Members!
			</h3>
			<h1 className=" text-lg font-medium  lg:text-start  lg:font-normal">
			...
			<section className="mb-12 grid items-center justify-center gap-4 py-8 md:grid-cols-12">
				...
				<div className="col-span-6">
					<h1 className=" text-base font-medium  lg:mb-3 lg:text-start  lg:font-normal">
					...
					<p className="mb-3 text-base font-bold text-gray-700 dark:text-gray-400 ">
						IEEE Tunisian SYP is pleased to offer attendees a two packs option:
					</p>

					<ul class=" ml-4 list-disc">
						<li className="ml-4 text-base font-normal text-gray-700 dark:text-gray-400 ">
					...
					<div className="flex flex-wrap justify-center my-2">
						< p className="ml-4 text-base font-normal text-gray-700 dark:text-gray-400 mr-3 mt-2">For any inquiries, feel free to contact us at: tsyp@ieee.org</p>
						<Link

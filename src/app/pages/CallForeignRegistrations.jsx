	...
	return (
		<div className="my-8  ">
			<div className="h-screen">
				<section className="py-8">
					...
					<div className="mb-6 flex flex-wrap justify-center gap-4">
						...
						>
							<span className="flex items-center justify-center">Pre Registration </span>
						</Link>
						...
						>
							<span className="flex items-center justify-center">Foreign Registation <svg class="h-6 w-6 ml-4 text-gray-600"  width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">  <path stroke="none" d="M0 0h24v24H0z"/>  <circle cx="12" cy="12" r="9" />  <line x1="3.6" y1="9" x2="20.4" y2="9" />  <line x1="3.6" y1="15" x2="20.4" y2="15" />  <path d="M11.5 3a17 17 0 0 0 0 18" />  <path d="M12.5 3a17 17 0 0 1 0 18" /></svg> </span>
						</Link>
					</div>
				</section>
			</div>
			...
			{/* <h1 className=" text-lg font-medium  dark:text-gray-300 lg:text-start lg:font-normal">
				IEEE Tunisian SYP Congress 2024 is co-organized by IEEE Tunisia Section
				& IEEE ENETCOM SB. It is scheduled to take place from the
			...
			{/* <section className="mb-12 grid items-center justify-center gap-4 py-8 md:grid-cols-12">
				...
				<div className="col-span-6">
					<h1 className=" text-base font-medium dark:text-gray-300 lg:mb-3 lg:text-start  lg:font-normal">
						Building on the success of previous events like Tunisian SYP11 2023
						, R8SYP 2022, TSYPX 2022, NASYP 2021 all held in Tunisia, the
						expectations within the IEEE community have never been higher. This
						year, <span className="font-bold">Tunisian SYP12</span> continues
						its legacy as one of the biggest Tech congresses in Tunisia, with an
						audience of 1200+ national & international engineering students and
						young professionals.
					</h1>
					...
					<ul class=" ml-4 list-disc">
						<li className="ml-4 text-base font-normal text-gray-700 dark:text-gray-300 ">
							<span className="font-bold">
								Event Registration (US$105 - Professional / US$85 - Student)
							</span>
							: Includes access to all technical and non-technical sessions,
							panel discussions, keynote speeches, ceremonies, TN2056 forum,
							Tunisian SYP EXPO, networking breaks, dinner on Days 1 and 2,
							lunch on Day 2, and social activities. A welcome kit is also
							provided.
						</li>
						<li className="ml-4 text-base font-normal text-gray-700 dark:text-gray-300 ">
							<span className="font-bold">
								Full Registration Options (Professionals & Students)
							</span>
							: Includes Event Registration and 2-night hotel accommodation
							(December 22nd - 24th):
							<ul class=" ml-4 list-disc">
								<li className="ml-4 text-base font-normal text-gray-700 dark:text-gray-300 ">
									<span className="font-bold">Double Room:</span> US$205 -
									Professional / US$185 - Student ( US$50 per night)
								</li>
								<li className="ml-4 text-base font-normal text-gray-700 dark:text-gray-300 ">
									<span className="font-bold">Single Room:</span> US$245 -
									Professional / US$225 - Student ( US$70 per night)
								</li>
							</ul>
						</li>
					</ul>
			...
			<div id="foreign-registration" className="my-2  ">
				...
				<h3 className="mb-4 text-center text-2xl font-bold dark:text-gray-300 lg:mb-8 lg:text-2xl lg:font-extrabold lg:leading-none">
				Foreign  Registration for the IEEE Tunisian SYP Congress 2024 is NOW OPEN
				</h3>
					...
					<div className="col-span-6">
						...
						<ul class=" ml-4 list-disc">
							<li className="ml-4 text-base font-normal text-gray-700 dark:text-gray-300 ">
								...
								: Includes access to all technical and non-technical sessions,
								panel discussions, keynote speeches, ceremonies, TN2056 forum,
								Tunisian SYP EXPO, networking breaks, and social activities. A welcome kit is also
								provided.
							</li>
							<li className="ml-4 text-base font-normal text-gray-700 dark:text-gray-300 ">
								<span className="font-bold">
